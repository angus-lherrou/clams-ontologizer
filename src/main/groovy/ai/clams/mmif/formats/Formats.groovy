...
//    }
    ...
    void initTypeMap() {
        ...
        TYPE_MAP = [
            ...
            "List of pairs": ResourceFactory.createResource("$DATATYPE#pair_list"),
            "Set of IDs": IDREFS,
            "String": XSD.xstring,
            "String or URI": XSD.xstring,
            "Object": ResourceFactory.createResource('https://json-schema.org/understanding-json-schema/reference/object.html')
        ]
    }
...
//    }
    ...
    void makeOntology(File script, RDFFormat format, File destination, String ext) {
        //initTypeMap()
        compile(script.text)
...
//                theClass.addProperty(property, value.type)
        ...
        File file = new File(destination, "clams.vocabulary.${ext}")
...
//        cli.p(longOpt:'package', args:1, 'package name for the Java class.')
        ...
        if (params.v) {
            ...
            InputStream stream = Formats.getResourceAsStream('/build')
            if (stream) {
...
//        }
        ...
        if (params.r) {
            ...
            dsl.makeOntology(scriptFile, format, destination, ext)
        }
